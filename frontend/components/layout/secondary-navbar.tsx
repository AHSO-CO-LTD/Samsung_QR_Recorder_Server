...
export function SecondaryNavbar({ group, pathname, onItemSelect }: SecondaryNavbarProps) {
  ...
  return (
    <nav className="absolute left-0 right-0 top-full z-30 bg-background" aria-label={t("secondaryNavigation")}>
      <div className="mx-auto flex w-full max-w-[1440px] justify-start gap-2 overflow-x-auto px-3 py-2 [scrollbar-width:none] sm:justify-center sm:px-4 [&::-webkit-scrollbar]:hidden">
